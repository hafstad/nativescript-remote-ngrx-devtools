...
export class Connection implements ReduxDevtoolsExtensionConnection {
    constructor(public remotedev: any, public instanceId: string, private _applicationRef: ApplicationRef) {}
    init() {}
    error() {}
